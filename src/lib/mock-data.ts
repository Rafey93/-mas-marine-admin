...
export const students: Student[] = [
  { id: 's1',  name: 'Ahmed Al-Rashidi',    email: 'ahmed.r@androsmarine.edu',    rank: 'Chief Officer',     course: 'STCW Basic Safety Training',       enrollmentDate: '2025-01-15', status: 'Active',    progress: 82, riskScore: 85 },
  { id: 's2',  name: 'Maria Santos',        email: 'm.santos@androsmarine.edu',   rank: 'Deck Cadet',        course: 'Navigation & Watchkeeping',         enrollmentDate: '2025-01-20', status: 'Active',    progress: 45, riskScore: 42 },
  { id: 's3',  name: 'James Okafor',        email: 'j.okafor@androsmarine.edu',   rank: 'Second Engineer',   course: 'Tanker Safety (Oil)',                enrollmentDate: '2025-02-01', status: 'Completed', progress: 100, riskScore: 91 },
  { id: 's4',  name: 'Priya Nair',          email: 'p.nair@androsmarine.edu',     rank: 'Third Officer',     course: 'GMDSS Radio Operations',            enrollmentDate: '2025-02-10', status: 'Active',    progress: 67, riskScore: 73 },
  { id: 's5',  name: 'Carlos Mendes',       email: 'c.mendes@androsmarine.edu',   rank: 'Bosun',             course: 'Firefighting & Fire Prevention',    enrollmentDate: '2025-02-14', status: 'Inactive',  progress: 30, riskScore: 38 },
  { id: 's6',  name: 'Yuki Tanaka',         email: 'y.tanaka@androsmarine.edu',   rank: 'Chief Engineer',    course: 'Ship Security Officer',             enrollmentDate: '2025-02-20', status: 'Completed', progress: 100, riskScore: 88 },
  { id: 's7',  name: 'Ibrahim Hassan',      email: 'i.hassan@androsmarine.edu',   rank: 'AB Seaman',         course: 'Personal Survival Techniques',      enrollmentDate: '2025-03-01', status: 'Active',    progress: 55, riskScore: 61 },
  { id: 's8',  name: 'Elena Volkov',        email: 'e.volkov@androsmarine.edu',   rank: 'Second Officer',    course: 'Elementary First Aid',              enrollmentDate: '2025-03-05', status: 'Active',    progress: 78, riskScore: 79 },
  { id: 's9',  name: 'Mohammed Al-Farsi',   email: 'm.alfarsi@androsmarine.edu',  rank: 'Captain',           course: 'STCW Basic Safety Training',        enrollmentDate: '2025-03-10', status: 'Completed', progress: 100, riskScore: 95 },
  { id: 's10', name: 'Grace Obi',           email: 'g.obi@androsmarine.edu',      rank: 'Deck Cadet',        course: 'Navigation & Watchkeeping',         enrollmentDate: '2025-03-15', status: 'Active',    progress: 22, riskScore: 28 },
  { id: 's11', name: 'Lars Eriksen',        email: 'l.eriksen@androsmarine.edu',  rank: 'Third Engineer',    course: 'Tanker Safety (Oil)',               enrollmentDate: '2025-03-20', status: 'Active',    progress: 60, riskScore: 65 },
  { id: 's12', name: 'Fatima Al-Zahra',     email: 'f.alzahra@androsmarine.edu',  rank: 'Purser',            course: 'Ship Security Officer',             enrollmentDate: '2025-03-25', status: 'Inactive',  progress: 15, riskScore: 22 },
  { id: 's13', name: 'Raj Patel',           email: 'r.patel@androsmarine.edu',    rank: 'Chief Officer',     course: 'GMDSS Radio Operations',            enrollmentDate: '2025-04-01', status: 'Active',    progress: 88, riskScore: 82 },
  { id: 's14', name: 'Sofia Andrade',       email: 's.andrade@androsmarine.edu',  rank: 'Catering Officer',  course: 'Elementary First Aid',              enrollmentDate: '2025-04-05', status: 'Active',    progress: 50, riskScore: 55 },
  { id: 's15', name: 'Chen Wei',            email: 'c.wei@androsmarine.edu',      rank: 'Second Engineer',   course: 'Firefighting & Fire Prevention',    enrollmentDate: '2025-04-08', status: 'Completed', progress: 100, riskScore: 90 },
  { id: 's16', name: 'Kwame Asante',        email: 'k.asante@androsmarine.edu',   rank: 'AB Seaman',         course: 'Personal Survival Techniques',      enrollmentDate: '2025-04-10', status: 'Active',    progress: 40, riskScore: 44 },
  { id: 's17', name: 'Natasha Ivanova',     email: 'n.ivanova@androsmarine.edu',  rank: 'Bosun',             course: 'STCW Basic Safety Training',        enrollmentDate: '2025-04-12', status: 'Active',    progress: 72, riskScore: 70 },
  { id: 's18', name: 'Pedro Alves',         email: 'p.alves@androsmarine.edu',    rank: 'Third Officer',     course: 'Navigation & Watchkeeping',         enrollmentDate: '2025-04-13', status: 'Inactive',  progress: 10, riskScore: 18 },
  { id: 's19', name: 'Aisha Bello',         email: 'a.bello@androsmarine.edu',    rank: 'Deck Cadet',        course: 'Elementary First Aid',              enrollmentDate: '2025-04-14', status: 'Active',    progress: 35, riskScore: 36 },
  { id: 's20', name: 'Viktor Kovalenko',    email: 'v.kovalenko@androsmarine.edu',rank: 'Captain',           course: 'Ship Security Officer',             enrollmentDate: '2025-04-15', status: 'Active',    progress: 95, riskScore: 92 },
];
